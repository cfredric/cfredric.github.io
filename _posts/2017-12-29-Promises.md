...
scopes. Additionally, having to use so many anonymous functions is a little
unfamiliar. Functional programmers may be used to it, but JavaScript is mostly
an imperative language -- it would be nice to keep it looking like one. Finally,
now we have better error forwarding, but we're still stuck having two different
