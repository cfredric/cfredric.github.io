...
the third row does. (In fact, the fourth row also starts to demonstrate that sum
types can embed more complicated variants - even full-fledged products).

Some readers will undoubtedly think, "C++ could absolutely represent that third
